package com.frodare.battlebotcraft.entities;
...
import com.frodare.battlebotcraft.entities.render.RenderBattleBot;
...
public class EntityBattleBot extends EntityCreature {
	...
	public static String NAME = "battlebot";

	public static void init(int entityId) {
		EntityRegistry.registerModEntity(EntityBattleBot.class, NAME, entityId, BattleBotCraft.INSTANCE, 80, 2, true, 0x3f3024, 0xe0d6b9);
	}

	public static void registerRenders() {
		RenderingRegistry.registerEntityRenderingHandler(EntityBattleBot.class, new IRenderFactory<EntityBattleBot>() {
			@Override
			public Render<EntityBattleBot> createRenderFor(RenderManager manager) {
				return new RenderBattleBot(manager);
			}
		});
	}

	public EntityBattleBot(World worldIn) {
		super(worldIn);
		setSize(0.6F, 1.95F);
